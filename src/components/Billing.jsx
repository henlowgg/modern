    ...
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Utilizing our FinTech, users can enjoy the ease of funneling money into Fortune 500 companies off shore accounts while ensuring your wallet stays empty.
        </p>
